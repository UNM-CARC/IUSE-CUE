...
{
  \newcommand{\patrick}[1]{\textcolor{orange}{[PATRICK: #1]}}
  \newcommand{\ep}[1]{\textcolor{green}{[ENRICO: #1]}}
  \newcommand{\dongwan}[1]{\textcolor{blue}{[DONGWAN: #1]}}
  \newcommand{\selena}[1]{\textcolor{purple}{[SELENA: #1]}}
  \newcommand{\melanie}[1]{\textcolor{blue}{[MELANIE: #1]}}
